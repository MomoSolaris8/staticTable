...
// dummy data done
// here I can repalce with my own data model type
...
// EXAMPLE_DATA is the real data 
const EXAMPLE_DATA : TableElement[] =[
    { id: 1, name: "Hydrogen", weight: 1.0079, symbol: "H", amount: 2 },
    ...
    { id: 7, name: "Nitrogen", weight: 14.0067, symbol: "N", amount: 5 },
    { id: 8, name: "Oxygen", weight: 15.9994, symbol: "O", amount: 1 },
    { id: 9, name: "Fluorine", weight: 18.9984, symbol: "F", amount: 10 },
    { id: 10, name: "Neon", weight: 20.1797, symbol: "Ne", amount:  6},
...
// come from the Andrew Bateman , his code work very well !


//  1 : Data Source for the Data table View. 
//This clss should be encapsulate all loic for fetchung and manipulating the displayed data
// It including sorting , pagination and filtering !

export class DataTableDataSource extends DataSource<TableElement> {
    data: TableElement[] = EXAMPLE_DATA;
   ...
   */
    ...
    private getPagedData(data:TableElement[]){
   ...
   */
    ...
    private getSortedData(data: TableElement[]){
        if(!this.sort.active || this.sort.direction ===""){
            return data;
        }

        return data.sort((a,b)=>{
            const isAsc = this.sort.direction ==="asc"; // ASC
